...
export const categoryMarkers: Record<string, MarkerData[]> = {
  beaches: [
    { id: "mirissa",    name: "Mirissa",    x: 38, y: 80, category: "beaches",  image: pkgCoast,      description: "Blue whales & golden crescent bay" },
    { id: "unawatuna",  name: "Unawatuna",  x: 30, y: 78, category: "beaches",  image: galYacht,      description: "Coral reef snorkelling & calm waters" },
    { id: "arugam-bay", name: "Arugam Bay", x: 75, y: 63, category: "beaches",  image: galYacht,      description: "World-class surf point, east coast" },
    { id: "bentota",    name: "Bentota",    x: 24, y: 65, category: "beaches",  image: pkgCoast,      description: "Lagoon waterways & beach retreat" },
    { id: "nilaveli",   name: "Nilaveli",   x: 57, y: 28, category: "beaches",  image: galYacht,      description: "Pristine white sands, Pigeon Island reefs" },
  ],
  "history-culture": [
    { id: "sigiriya",      name: "Sigiriya",      x: 45, y: 41, category: "history-culture", image: destSigiriya,  description: "5th-century Lion Rock fortress" },
    { id: "anuradhapura",  name: "Anuradhapura",  x: 42, y: 33, category: "history-culture", image: galTemple,     description: "Ancient sacred city, 3rd century BC" },
    { id: "polonnaruwa",   name: "Polonnaruwa",   x: 51, y: 42, category: "history-culture", image: galTemple,     description: "Medieval royal capital, UNESCO site" },
    { id: "dambulla",      name: "Dambulla",      x: 43, y: 43, category: "history-culture", image: galTemple,     description: "Cave temples with golden Buddhas" },
    { id: "kandy",         name: "Kandy",         x: 46, y: 51, category: "history-culture", image: galTemple,     description: "Sacred Temple of the Tooth Relic" },
  ],
  wildlife: [
    { id: "yala",          name: "Yala",          x: 63, y: 68, category: "wildlife", image: actSafari,    description: "World's highest leopard density" },
    { id: "udawalawe",     name: "Udawalawe",     x: 53, y: 69, category: "wildlife", image: pkgYala,      description: "Wild elephant herds at close range" },
    { id: "wilpattu",      name: "Wilpattu",      x: 28, y: 32, category: "wildlife", image: pkgYala,      description: "Sri Lanka's largest national park" },
    { id: "horton-plains", name: "Horton Plains", x: 46, y: 59, category: "wildlife", image: heroHighlands, description: "Cloud-forest plateau & World's End" },
    { id: "sinharaja",     name: "Sinharaja",     x: 38, y: 69, category: "wildlife", image: heroHighlands, description: "UNESCO rainforest, endemic species" },
  ],
  "hidden-gems": [
    { id: "jaffna",     name: "Jaffna",     x: 27, y: 6,  category: "hidden-gems", image: galTemple,     description: "Ancient Tamil culture, Nallur Kovil" },
    { id: "mannar",     name: "Mannar",     x: 23, y: 20, category: "hidden-gems", image: pkgCoast,      description: "Flamingo flats & Adam's Bridge" },
    { id: "kalpitiya",  name: "Kalpitiya",  x: 19, y: 35, category: "hidden-gems", image: galYacht,      description: "Kitesurfing & spinner dolphins" },
    { id: "knuckles",   name: "Knuckles",   x: 50, y: 45, category: "hidden-gems", image: heroHighlands, description: "Mist-shrouded highland wilderness" },
    { id: "belihuloya", name: "Belihuloya", x: 43, y: 62, category: "hidden-gems", image: heroHighlands, description: "Remote river valley, tea estate trails" },
  ],
  adventure: [
    { id: "ella",       name: "Ella",       x: 55, y: 60, category: "adventure", image: galTea,        description: "Nine Arch Bridge & highland hikes" },
    { id: "kitulgala",  name: "Kitulgala",  x: 36, y: 55, category: "adventure", image: heroHighlands, description: "White-water rafting, jungle canopy" },
    { id: "adams-peak", name: "Adam's Peak",x: 41, y: 60, category: "adventure", image: heroHighlands,  description: "Pre-dawn pilgrimage, sacred summit" },
  ...
  gastronomy: [
    ...
    { id: "galle-g",  name: "Galle",    x: 33, y: 79, category: "gastronomy", image: destGalle,    description: "Fort restaurants, Dutch-era heritage" },
    { id: "kandy-g",  name: "Kandy",    x: 46, y: 49, category: "gastronomy", image: galTemple,    description: "Kandyan cuisine & cooking classes" },
    { id: "jaffna-g", name: "Jaffna",   x: 27, y: 6, category: "gastronomy", image: galTemple,    description: "Chettinad spices, crab curry, hoppers" },
    { id: "negombo",  name: "Negombo",  x: 21, y: 49, category: "gastronomy", image: pkgCoast,     description: "Seafood lagoon, fish market culture" },
  ],
};
